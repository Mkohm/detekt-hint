...
\todo{describe the focus mentioning the dimensions of the prototype}
...
\todo{describe the focus mentioning the dimensions of the prototype, it is a prototype trying to cover all the dimensions of a prototype, being a more of a MVP}
...
Images prestented in prototypes may leave the impression that the tool is more accurate than it actually is. Even if telling the users that the tool would generate false-positives, this may have given them false-forhåpninger, making them overly positive to such a tool. 
...
First of all, a big thanks to my supervisor Hallvard Trætteberg for advice, useful discussions and for help in getting in touch with experienced developers. Also a, thanks to JavaBin Trondheim for letting me have a presentation, showing the prototype. Also, thanks to the participants of the semi-structured interview.
