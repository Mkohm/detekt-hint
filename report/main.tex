...
\begin{figure}[h!]%
    ...
    \subfloat[First prototype]{{\includegraphics[width=5cm]{images/initial2.png} }}%
    \qquad
    \subfloat[Second prototype]{{\includegraphics[width=5cm]{images/vertical2.png} }}%
    
    \subfloat[Third prototype]{{\includegraphics[width=5cm]{images/horizontal2.png} }}
    \qquad
    \subfloat[Fourth prototype]{{\includegraphics[width=5cm]{images/final2.png} }}
