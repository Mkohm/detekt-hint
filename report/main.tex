...
\todo{double check objectives of solution answered}
...
\todo{restructure and Put together a better overall evaluation, using both the internal and external evaluation. Saying that the external evaluation complements the findings in the internal evaluation. etc. }
