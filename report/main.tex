...
\begin{figure}[h!]%
    ...
    \subfloat[label 1]{{\includegraphics[width=\linewidth/3]{report/images/initial2.png} }}%
    
    \subfloat[label 1]{{\includegraphics[width=\linewidth/3]{report/images/vertical2.png} }}%
    
    \subfloat[label 2]{{\includegraphics[width=\linewidth]{report/images/horizontal.png} }}
    
    \subfloat[label 2]{{\includegraphics[width=\linewidth]{report/images/final.png} }}
