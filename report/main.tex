...
\chapter{Results}
The results include the produced artifacts and the evaluation of those. The results are presented it the order they were achieved, making the next section a result of the previous one.



\section{Evaluation results}
In the next sections you will find the evaluations taken on the different stages of the development process, and how i responded to it.

\subsection{Initial prototype}


An initial prototype was created to see if there was any interest in a tool for detecting design principle violations. A mockup was created and posted on the subforum of Kotlin and SoftwareArchitecture on reddit.


Outcome of this: Showed that there is interest in a tool like this, and that it would be worth spending more time on. People think it is an interesting project. Focus on reducing false-positives. Confirmed my initial OS.
...
The horizontal prototype was built by creating sample \gls{pr} in a sample repository on Github\cite{sample-repository}, and then commenting on the \gls{pr}'s with the bot user. An example from the prototype is presented in figure \ref{fig:liskov}. It 
...
The final artifact is a continuation of the work done in the vertical prototype, and hence has the same qualities and ways of solving the objectives of a solution.
...
Should create samples for the horizontal prototype that demonstrates possible false positives as well as true positives. 
