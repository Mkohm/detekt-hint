...
\begin{figure}[h!]%
    ...
    \subfloat[label 1]{{\includegraphics[width=5cm]{report/images/initial2.png} }}%
    
    \subfloat[label 1]{{\includegraphics[width=5cm]{report/images/vertical2.png} }}%
    
    \subfloat[label 2]{{\includegraphics[width=5cm]{report/images/horizontal2.png} }}
    
    \subfloat[label 2]{{\includegraphics[width=5cm]{report/images/final2.png} }}
